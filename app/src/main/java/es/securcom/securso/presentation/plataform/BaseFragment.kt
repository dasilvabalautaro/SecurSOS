...
import es.securcom.securso.R.color
import es.securcom.securso.di.ApplicationComponent
import es.securcom.securso.extension.appContext
import es.securcom.securso.extension.viewContainer
import es.securcom.securso.model.exception.Failure
import es.securcom.securso.model.persistent.BuildPackageData
...
import es.securcom.securso.presentation.presenter.PostRepositoryViewModel
import es.securcom.securso.presentation.tools.Conversion
import es.securcom.securso.presentation.view.fragment.AlarmFragment
...
abstract class BaseFragment: Fragment() {
    ...
    protected var observableFillCreate: Subject<Int> = PublishSubject.create()
